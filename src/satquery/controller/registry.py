...
from satquery.contracts import ToolContract, ToolError
...
class ToolRegistry:
    ...
    def get(self, tool_id: str, version: str) -> Optional[Tuple[ToolContract, Any]]:
    ...
    def validate_executable(
        ...
        # Target verification
        if target and contract.allowed_targets:
